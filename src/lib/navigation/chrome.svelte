...
<div data-tauri-drag-region class="h-8 bg-primary-200 toolbar text-neutral-400 flex flex-row col-span-2
  ...
  <div class="text-base flex h-full">
    <button
      class="h-full hover:bg-neutral-700 hover:text-white px-3"
    ...
    <button
      class="h-full hover:bg-red-600 hover:text-white px-3"
